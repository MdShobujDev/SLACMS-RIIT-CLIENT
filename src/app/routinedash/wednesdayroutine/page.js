    ...
    onSubmit: async (values) => {
      try {
        ...
        const response = await axios.put(
          `https://slacms-riit-server-ashen.vercel.app/api/routines/928d0f8b-3f29-4180-bfef-366571110ce9/weeklyRoutine/wednesday`,
          Newperiods
        );
        ...
        if (response.data.statusText === "ok") {
          ...
          nextStep();
          router.push("/routinedash/thursdayroutine");
        }
      } catch (error) {
