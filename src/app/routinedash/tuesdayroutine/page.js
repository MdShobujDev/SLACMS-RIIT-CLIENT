    ...
    onSubmit: async (values) => {
      try {
        ...
        const response = await axios.put(
          `https://slacms-riit-server-ashen.vercel.app/api/routines/928d0f8b-3f29-4180-bfef-366571110ce9/weeklyRoutine/tuesday`,
          Newperiods
        );
        ...
        if (response.data.statusText === "ok") {
          ...
          nextStep();
          router.push("/routinedash/wednesdayroutine");
        }
      } catch (error) {
    ...
    <div className="w-full mb-5 mx-auto">
      ...
      <div className="py-6">
        <h1 className="font-bold text-3xl">
          Step : 3 - Set here your{" "}
          <span className="text-red-600 text-4xl font-extrabold">Tuesday</span>{" "}
          class routine
        </h1>
